...
function ShareButtons({ gameUrl }) {
  const shareViaWhatsApp = () => {
    const whatsappUrl = `https://wa.me/?text=${encodeURIComponent(gameUrl)}`;
  ...
  return (
    <div className="share-url">
      ...
      <div className="share-buttons-container">
        <button
          type="button"
          class="btn btn-success share-buttons"
        ...
        <button
          type="button"
          className="btn btn-primary share-buttons"
